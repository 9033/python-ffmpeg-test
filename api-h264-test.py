...
class AVCodecDescriptor(ctypes.Structure): #avcodec.h   
    _fields_ = (('id', c_int), #enum AVCodecID
                ('type', c_int), #enum AVMediaType
                ('name', c_char_p),
                ('long_name', c_char_p),
                ('props', c_int),
                ('mime_types', POINTER(c_char_p)),
                ('profiles', POINTER(AVProfile)))    
#AVCodecDescriptor
class RcOverride(ctypes.Structure): #avcodec.h
    pass
class RcOverride(ctypes.Structure): #avcodec.h
    _fields_ = (('start_frame', c_int),
                ('end_frame', c_int),
                ('qscale', c_int),
                ('quality_factor', c_float)
    )
#RcOverride
class MpegEncContext(ctypes.Structure): #avcodec.h
    pass
...
class AVFrameSideData(ctypes.Structure): #frame.h
    pass
class AVOptionRange(ctypes.Structure): #opt.h
    pass
class AVOptionRanges(ctypes.Structure): #opt.h
    pass
...
class AVCodecParser(ctypes.Structure): #avcodec.h
    _fields_=(('codec_ids',c_int*5),
              ('priv_data_size',c_int),
              ('parser_init',POINTER(CFUNCTYPE(c_int,POINTER(AVCodecParserContext)))),
              ('parser_parse',POINTER(CFUNCTYPE(c_int,POINTER(AVCodecParserContext),
              ...
              ('split',POINTER(CFUNCTYPE(c_int,POINTER(AVCodecParserContext),POINTER(c_uint8),c_int))),
              ('next',POINTER(AVCodecParser)))
#AVCodecParser

AV_PARSER_PTS_NB=4 #avcodec.h   
class AVCodecParserContext(ctypes.Structure): #avcodec.h
    _fields_=(('priv_data',c_void_p),
              ...
              ('cur_frame_offset',c_int64*AV_PARSER_PTS_NB),
              ('cur_frame_pts',c_int64*AV_PARSER_PTS_NB),
              ('cur_frame_dts',c_int64*AV_PARSER_PTS_NB),
              ('flags',c_int),
              ('offset',c_int64),
              ('cur_frame_end',c_int64*AV_PARSER_PTS_NB),
              ('key_frame',c_int),
              ('convergence_duration',c_int64),
              ('dts_sync_point',c_int),
              ('dts_ref_dts_delta',c_int),
              ('pts_dts_delta',c_int),
              ('cur_frame_pos',c_int64*AV_PARSER_PTS_NB),
              ('pos',c_int64),
              ('last_pos',c_int64),
              ('duration',c_int),
              ('field_order',c_int), #enum AVFieldOrder
              ('picture_structure',c_int), #enum AVPictureStructure
...
class MpegEncContext(ctypes.Structure): #mpegvideo.h
    _fields_=()
#MpegEncContext
class AVRational(ctypes.Structure): #rational.h
    _fields_=(('num',c_int),
...
class AVBuffer(ctypes.Structure): #dict.h
    _fields_=(('data',POINTER(c_uint8)),
              ...
              ('free',POINTER(CFUNCTYPE(None,c_void_p,POINTER(c_uint8)))),
              ('opaque',c_void_p),
              ('flags',c_int))
#AVBuffer
class AVBufferRef(ctypes.Structure): #buffer.h
    _fields_ = (('buffer',POINTER(AVBuffer)),
...
#AVCodecHWConfig
class AVCodecHWConfigInternal(ctypes.Structure):
    _fields_=(('public',AVCodecHWConfig),
...
#AVOptionRange
class AVOptionRanges(ctypes.Structure): #opt.h
    _fields_ = (('range',POINTER(POINTER(AVOptionRange))),
                ('nb_ranges', c_int),
                ('nb_components', c_int))
#AVOptionRanges
AV_NUM_DATA_POINTERS=8 #frame.h
AV_INPUT_BUFFER_PADDING_SIZE=64 #avcodec.h
class _default_val_union(ctypes.Union):
    _fields_ = (('i64', c_int64),
                ('dbl', c_double),
                ('str', c_char_p),
                ('q', AVRational))
                
class AVOption(ctypes.Structure): #opt.h
    _fields_ = (('name', c_char_p),
                ('help', c_char_p),
                ('offset', c_int),
                ('type', c_int),#enum AVOptionType
                ('default_val', _default_val_union),
                ('min', c_double),
                ('max', c_double),
                ('flags', c_int),
                ('unit', c_char_p))
#AVOption
class AVClass(ctypes.Structure): #log.h
    _fields_ = (('class_name', c_char_p),
                ('item_name', POINTER(CFUNCTYPE(c_char_p,c_void_p))),
                ('option', POINTER(AVOption)),
                ('version', c_int),
                ('log_level_offset_offset', c_int),
                ('parent_log_context_offset', c_int),
                ('child_next', POINTER(CFUNCTYPE(c_void_p,c_void_p,c_void_p))),
                ('child_class_next', POINTER(CFUNCTYPE(POINTER(AVClass),POINTER(AVClass)))),
                ('category', c_int),#enum AVClassCategory
                ('get_category', POINTER(CFUNCTYPE(c_int,c_void_p))), #enum AVClassCategory
                ('query_ranges', POINTER(CFUNCTYPE(c_int,POINTER(POINTER(AVOptionRanges)),c_void_p,c_char_p,c_int))))
#AVClass
class AVFrameSideData(ctypes.Structure): #frame.h
    _fields_ = (('type', c_int), #enum AVFrameSideDataType
                ('data', POINTER(c_uint8)),
                ('size', c_int),
...
class AVPicture(ctypes.Structure): #avcodec.h 
    _fields_ = (('data'        ,POINTER(c_uint8)*AV_NUM_DATA_POINTERS),
                ('linesize'        ,c_uint8*AV_NUM_DATA_POINTERS))
#AVPicture
class AVSubtitleRect(ctypes.Structure): #avcodec.h 
    _fields_ = (('x'        ,c_int),
                ('y'        ,c_int),
                ('w'        ,c_int),
                ('h'        ,c_int),
                ('nb_colors',AVPicture),
                ('pict',c_int),                
                ('data',POINTER(c_uint)*4),
                ('linesize',(c_int*4)),
                ('type', c_int), #enum AVSubtitleType
                ('text', c_char_p),
                ('ass', c_char_p),
                ('flags', c_int))
#AVSubtitle
class AVSubtitle(ctypes.Structure): #avcodec.h 
    _fields_ = (('format', c_uint16),
...
class AVHWAccel(ctypes.Structure):  #avcodec.h 
    _fields_ = (('name', c_char_p),
                ...
                ('pix_fmt', c_int), #enum AVPixelFormat
                ('capabilities', c_int),
                ('alloc_frame', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext),POINTER(AVFrame)))),
                ('start_frame', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext),POINTER(c_uint8),c_uint32))),
                ('decode_params', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext),c_int,POINTER(c_uint8),c_uint32))),
                ('decode_slice', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext),POINTER(c_uint8),c_uint32))),
                ('end_frame', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext)))),
                ('frame_priv_data_size', c_int),
                ('decode_mb', POINTER(CFUNCTYPE(None,POINTER(MpegEncContext)))),
                ('init', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext)))),
                ('uninit', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext)))),
                ('priv_data_size', c_int),
                ('caps_internal', c_int),
                ('frame_params', POINTER(CFUNCTYPE(c_int,POINTER(AVCodecContext),POINTER(AVBufferRef))))
    )
#AVHWAccel
...
class AVIOInterruptCB(ctypes.Structure): #avio.h
    _fields_ = [
        ('callback', POINTER(CFUNCTYPE(POINTER(c_int),c_void_p))),
        ('opaque', c_void_p)
    ]
class AVCodecParameters(ctypes.Structure): #avcodec.h 
    _fields_ = [
...
def h264_test(): #api-h264-test.c
    ...
    avcodec.avcodec_close.argtypes=[POINTER(AVCodecContext)]
    avcodec.avcodec_close.restype=c_int
